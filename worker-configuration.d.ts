...
declare namespace Cloudflare {
	...
	interface Env {
		...
		FAL_KEY: string;
		DATABASE_URL: string;
		PIPELINE_TRACKER: DurableObjectNamespace<import("./workers/app").PipelineTracker>;
		MY_BUCKET: R2Bucket;
	}
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "VALUE_FROM_CLOUDFLARE" | "CF_ACCOUNT_ID" | "CF_AIG_NAME" | "CF_AIG_TOKEN" | "FAL_KEY" | "DATABASE_URL">> {}
}
